...
2. Create a contract covering goal, deliverables, constraints, exclusions, acceptance criteria, evidence, dependencies, authorization boundaries, and explicit resource ceilings.
...
4. Give each worker its contract slice, objective, inputs, ownership, output format, checks, and stop condition. Preserve critical constraints.
